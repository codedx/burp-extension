...
public interface IBurpExtenderCallbacks
{
     ...
     * The report format can be specified. For all other reporting options, the
     * default settings that appear in the reporting UI wizard are used.
     * 
     * @param format
     * @param issues
     * @param file
    ...
    //not sure why this one wasn't here, had to add it in manually
